...
<head>
    <meta charset="UTF-8">
    <title>Dedit Card Reports - Prime Bank</title>
...
<body>
    ...
    <div class="main-content">
        <h1>Debit Card Reports</h1>

        <div class="report-list">
            <a href="dcReportDetails.jsp?reportType=transaction" class="report-card-link">
                <h3>Transaction Report</h3>
                <p>Access a comprehensive log of all debit card transactions.</p>
            </a>
            <a href="dcReportDetails.jsp?reportType=fee" class="report-card-link">
                <h3>Fees Report</h3>
                <p>Review a breakdown of all fees associated with debit cards.</p>
            </a>
            <a href="dcReportDetails.jsp?reportType=mis" class="report-card-link">
                <h3>MIS Report</h3>
                <p>Generate Management Information System reports for debit cards.</p>
            </a>
            <a href="dcReportDetails.jsp?reportType=tin" class="report-card-link">
