...
<body>
    ...
    <div class="main-content">
        <h1>Prepaid Card Reports</h1>

        <div class="report-list">
            <a href="pcReportDetails.jsp?reportType=transaction" class="report-card-link">
                <h3>Transaction Report</h3>
                <p>Access a comprehensive log of all prepaid card transactions.</p>
            </a>
            <a href="pcReportDetails.jsp?reportType=fees" class="report-card-link">
                <h3>Fees Report</h3>
                <p>Review a breakdown of all fees associated with prepaid cards.</p>
            </a>
            <a href="pcReportDetails.jsp?reportType=mis" class="report-card-link">
                <h3>MIS Report</h3>
                <p>Generate Management Information System reports for prepaid cards.</p>
            </a>
            <a href="pcReportDetails.jsp?reportType=tin" class="report-card-link">
                <h3>TIN Report</h3>
                <p>Get Taxpayer Identification Number (TIN) related reports.</p>
            </a>
        </div>
    </div>
