    ...
    <div class="main-content">
        <%
            ...
            if ("payment".equals(reportType)) {
                reportTitle = "Credit Card Payment Report";
            } else if ("transaction".equals(reportType)) {
                reportTitle = "Credit Card Transaction Report";
            } else if ("fees".equals(reportType)) {
                reportTitle = "Credit Card Fees Report";
            } else if ("mis".equals(reportType)) {
                reportTitle = "Credit Card MIS Report";
            } else if ("tin".equals(reportType)) {
                reportTitle = "Credit Card TIN Report";
            } else if ("cib_cl".equals(reportType)) {
                reportTitle = "Credit Card CIB-CL Report";
            }
        %>
