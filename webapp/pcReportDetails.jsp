...
<head>
    ...
    <style>
        ...
        .report-filter-form {
            ...
            gap: 20px;
            align-items: center; /* Align items to the bottom of their grid area */
        }
    ...
    <div class="main-content">
        <%
            ...
            if ("transaction".equals(reportType)) {
                reportTitle = "Prepaid Card Transaction Report";
            } else if ("fees".equals(reportType)) {
                reportTitle = "Prepaid Card Fees Report";
            } else if ("mis".equals(reportType)) {
                reportTitle = "Prepaid Card MIS Report";
            } else if ("tin".equals(reportType)) {
                reportTitle = "Prepaid Card TIN Report";
            }
        %>
