...
<head>
    ...
    <style>
        ...
        /*
         * Main Heading (H1)
         * Styles for the prominent "Credit Card Reports" title.
         */
        h1 {
            font-size: 38px;
        ...
        .report-list {
            display: grid;
            grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); /* Responsive grid columns for report cards */
            gap: 20px; /* Space between report cards */
            padding: 20px;
        ...
        .report-card-link { /* New class for the entire clickable card */
            text-decoration: none; /* Remove underline from the link */
            color: inherit; /* Inherit text color from parent */
            display: block; /* Make the anchor tag fill its grid cell */
...
<body>
    ...
    <div class="main-content">
        <h1>Credit Card Reports</h1>

        <div class="report-list">
            <a href="ccReportDetails.jsp?reportType=payment" class="report-card-link">
                <h3>Payment Report</h3>
                <p>View detailed records of all credit card payments.</p>
            </a>
            <a href="ccReportDetails.jsp?reportType=transaction" class="report-card-link">
                <h3>Transaction Report</h3>
                <p>Access a comprehensive log of all credit card transactions.</p>
            </a>
            <a href="ccReportDetails.jsp?reportType=fees" class="report-card-link">
                <h3>Fees Report</h3>
                <p>Review a breakdown of all fees associated with credit cards.</p>
            </a>
            <a href="ccReportDetails.jsp?reportType=mis" class="report-card-link">
                <h3>MIS Report</h3>
                <p>Generate Management Information System reports for credit cards.</p>
            </a>
            <a href="ccReportDetails.jsp?reportType=tin" class="report-card-link">
                <h3>TIN & NID Report</h3>
                <p>Get Taxpayer Identification Number (TIN) & NID related reports.</p>
            </a>
            <a href="ccReportDetails.jsp?reportType=cib_cl" class="report-card-link">
                <h3>CIB-CL Report</h3>
                <p>Access Credit Information Bureau (CIB) - Classified Loan (CL) reports.</p>
            </a>
        </div>
    </div>
